...
\input{Requisiti Del Software/Analisi dei Requisiti/Mockup/aggiungi annuncio/Introduzione MockUp Aggiungi Annuncio}

\clearpage
\newpage

\input{Requisiti Del Software/Analisi dei Requisiti/Mockup/disattivazione notifiche/descrizione mockup notifiche}


\input{Requisiti Del Software/Analisi dei Requisiti/Mockup/controproposta/MockUp Controproposta scenarioPrincipale}

\clearpage
\newpage

\input{Requisiti Del Software/Analisi dei Requisiti/Mockup/aggiungi nuovo agente/MockUp NuovoAgente scenarioPrincipale}
