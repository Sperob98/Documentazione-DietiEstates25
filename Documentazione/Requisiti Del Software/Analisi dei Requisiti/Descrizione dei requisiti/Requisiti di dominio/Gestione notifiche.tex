...
\begin{table}[H]
    ...
    \begin{tabular}{|p{3cm}|p{10cm}|} 
        ...
        \hline
        D-N2 & Le notifiche promozionali sono composte da un contenuto in formato RICH TEXT, definito dagli Manager, e sono visibili esclusivamente agli utenti iscritti alla relativa newsletter. \\ 
        \hline
    \end{tabular}
